  ...
  program
    ...
    .action(async (str, options) => {
      ...
      if (envConfig.standardVersionBump) {
        console.log(`bumping the version of the branch: ${currentBranchName}`);
      ...
      console.log('Returning to the original fix branch');

      git.checkoutLocalBranch(currentBranchName);
    });
